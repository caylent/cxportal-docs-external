# Voice Survey Campaigns

## Before You Begin

Voice Survey Campaigns collect feedback with interactive voice calls. Voice surveys can have up to 5 questions and responses are entered via keypad.

Before creating a Voice Survey campaign, make sure you have the following in place:
...
Keep the following limits in mind when building a Voice Survey campaign:

* **Up to 5 questions** — A single voice survey can include a maximum of five questions.
* **Keypad responses only** — Recipients answer using their keypad, so response types are limited to Yes/No, Rating Scale (1–5), or Open response.
...
7. Use the **Language dropdown** to select one or more languages. English is selected by default, but you can also add Spanish. When multiple languages are selected, question content can be entered per language.
8. Enter the text of your survey question in the question box. This text will be read aloud to the recipient.
9. (Optional) Click the **< > icon** to open the SSML editor. This allows you to control how the question is spoken. Options include:
...
10. Choose a **Response Type**. Select how the recipient should respond using the dropdown:
...
10. Click **+ Add New Question** to add additional questions (up to 5 total).
11. Click **Schedule** to proceed.
