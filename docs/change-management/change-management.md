...
* Executed changes are recorded on the **Audit Log** page, including changes that did not go through an approval step.
* An executed change can be reverted from its audit log record.
