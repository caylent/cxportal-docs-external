...
- **Role and Instance Access** — the **ROLE NAME**, a **Change Role** button, and an **Instance Name** table listing the instances the user can access. Each row identifies the instance by its alias rather than by its Amazon Connect instance ID.
